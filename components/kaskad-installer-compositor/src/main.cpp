...
Application::Application(int &argc, char **argv)
    ...
    , m_configLock(false)
    , m_config(KSharedConfig::openConfig(QStringLiteral("kaskadinstallerrc")))
    , m_kxkbConfig()
    , m_kdeglobals(KSharedConfig::openConfig(QStringLiteral("kaskadinstallerglobals")))
{
...
{
    KAboutData aboutData(QStringLiteral("kaskad-installer"), // The program name used internally
                         i18n("Kaskad Installer"), // A displayable program name string
                         KASKAD_INSTALLER_VERSION_STRING, // The program version string
                         i18n("Dedicated Wayland compositor for the KaskadOS installer"), // Short description of what the app does
                         KAboutLicense::GPL, // The license this code is released under
                         i18n("(c) 1999-2026, The KDE Developers; (c) 2026, The MacqueenDE and KaskadOS contributors")); // Copyright Statement

    aboutData.addAuthor(QStringLiteral("lyrka-meow"), i18n("KaskadOS maintainer"));
...
void Application::setupCommandLine(QCommandLineParser *parser)
{
    ...
    parser->setApplicationDescription(i18n("Dedicated Wayland compositor for the KaskadOS installer"));
