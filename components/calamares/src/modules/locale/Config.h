...
public:
    ...
    /// Offline timezone fallback configured for a locale such as ru or pt_BR.
    Calamares::GeoIP::RegionZonePair defaultTimezoneForLocale( const QString& localeName ) const;
    bool hasTimezoneForLocale( const QString& localeName ) const;
...
private:
    ...
    void setCurrentLocation( const Calamares::Locale::TimeZoneData* tz, LocationSource source );
    void setCurrentLocation( const Calamares::GeoIP::RegionZonePair& tz, LocationSource source );
    void setCurrentLocation( const QString& region, const QString& zone, LocationSource source );
    ...
    /// @brief Final fallback when no locale-specific timezone is configured.
    Calamares::GeoIP::RegionZonePair m_startingTimezone;

    /// @brief Offline mapping from normalized locale identifiers to timezones.
    QHash< QString, Calamares::GeoIP::RegionZonePair > m_localeTimezones;
