...
public:
     ...
     *  - all password-strength checks pass, or those checks are disabled
     * Weak is retained for API compatibility with frontends that distinguish
