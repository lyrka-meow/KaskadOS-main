...
Item {
    ...
    Item {
        ...
        IconImage {
            ...
            anchors.centerIn: parent
            implicitSize: appData && (appData.appId === "org.quickshell" || appData.appId === "org.macqueende.molniya") ? actualIconSize * 0.85 : actualIconSize
            source: {
                if (!appData || appData.appId === "__SEPARATOR__") {
                    return "";
                }
            ...
            layer.enabled: appData && (appData.appId === "org.quickshell" || appData.appId === "org.macqueende.molniya")
            layer.smooth: true
            layer.mipmap: true
