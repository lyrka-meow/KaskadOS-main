...
var SPEC = {
    currentThemeName: { def: "kaskados", onChange: "applyStoredTheme" },
    ...
    widgetBackgroundCustomColor: { def: "#9FE0B4" },
    ...
    workspaceFocusedCustomColor: { def: "#9FE0B4" },
    ...
    workspaceFocusedBorderCustomColor: { def: "#9FE0B4" },
    ...
    workspaceUnfocusedMonitorFocusedCustomColor: { def: "#9FE0B4" },
    ...
    workspaceUnfocusedMonitorBorderCustomColor: { def: "#9FE0B4" },
    ...
    updaterAutomaticEnabled: { def: true },
    updaterScheduleConfirmed: { def: false },
    updaterScheduleHour: { def: 3 },
    updaterScheduleMinute: { def: 0 },
    updaterScheduleDays: { def: 1 },
    updaterScheduleStartDate: { def: "" },
    updaterIdleFallbackEnabled: { def: true },
    updaterIdleMinutes: { def: 30 },
    updaterOnlyOnAC: { def: true },
    updaterLastAutomaticUnix: { def: 0 },
    updaterPostponedUntilUnix: { def: 0 },
