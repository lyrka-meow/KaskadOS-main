...
MolniyaMacqueenShell is the MacqueenDE shell derived from
[DankMaterialShell](https://github.com/AvengeMedia/DankMaterialShell).
The initial source import tracks upstream commit
`99f452c99949774c522af7dcfb39d764964cb4ec` and includes
`dank-qml-common` commit `1919595f0dde4f5bf5ac0baa1902ff6d070971d5`.

The original MIT license and copyright notices are preserved. Macqueen support
is developed as a dedicated compositor adapter; support for existing upstream
compositors remains available while the port is in progress.
